...
// Please place the robot so the right wheel is aligned with the right of the three strips

@Autonomous(name="Close Autonomous: RED", group="Skula and Joe")
public class AutoCloseRed extends BaseAuto {
    @Override
